...
Public Class TambahUserGuru
	...
	Sub autoNumeric()
		...
		Dim hitung As Long
		cmd = New MySqlCommand("SELECT * FROM guru WHERE idguru IN (SELECT MAX(idguru) FROM guru)", conn)
	...
	Private Sub TambahUserGuru_Load(sender As Object, e As EventArgs) Handles MyBase.Load
		kondisiAwal()
		munculDataGridView()
	...
	Private Sub TambahUserGuru_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
	...
	Private Sub btn_delete_Click(sender As Object, e As EventArgs) Handles btn_delete.Click
		...
		If TextBox2.Text = "" Or TextBox3.Text = "" Or TextBox4.Text = "" Or TextBox5.Text = "" Or TextBox7.Text = "" Then
		...
		Else
			...
			Else
				...
				If MsgBox("Apakah anda yakin ingin menghapus data ini?", MsgBoxStyle.OkCancel, "Informasi") = MsgBoxResult.Ok Then
					...
					koneksi()
					cmd = New MySqlCommand("DELETE FROM guru WHERE idguru='" & TextBox2.Text & "'", conn)
					cmd.ExecuteNonQuery()
	...
	Private Sub btn_tambah_Click(sender As Object, e As EventArgs) Handles btn_tambah.Click
		...
		Else
			...
			If TextBox2.Text = "" Or TextBox3.Text = "" Or TextBox4.Text = "" Or TextBox5.Text = "" Or TextBox7.Text = "" Or TextBox8.Text = "" Then
			...
			Else
				...
				If MsgBox("Apakah anda yakin ingin menyimpan data ini?", MsgBoxStyle.OkCancel, "Informasi") = MsgBoxResult.Ok Then
					...
					Call koneksi()
					cmd = New MySqlCommand("INSERT INTO guru VALUES('" & TextBox2.Text & "', '" & TextBox4.Text & "', '" & TextBox5.Text & "', '" & TextBox3.Text & "', '" & TextBox8.Text & "', '0', '" & TextBox7.Text & "', '')", conn)
					cmd.ExecuteNonQuery()
	...
	Private Sub btn_search_Click(sender As Object, e As EventArgs) Handles btn_search.Click
		...
		Call koneksi()
		cmd = New MySqlCommand("SELECT * FROM guru WHERE	username='" & TextBox1.Text & "' OR nama='" & TextBox1.Text & "' OR no_telp='" & TextBox1.Text & "'OR alamat='" & TextBox1.Text & "'", conn)
		dr = cmd.ExecuteReader
		dr.Read()
		...
		ElseIf dr.HasRows Then
			...
			koneksi()
			da = New MySqlDataAdapter("SELECT * FROM guru WHERE	username='" & TextBox1.Text & "' OR nama='" & TextBox1.Text & "' OR no_telp='" & TextBox1.Text & "'OR alamat='" & TextBox1.Text & "'", conn)
			ds = New DataSet
			da.Fill(ds, "guru")
			DataGridView1.DataSource = ds.Tables("guru")
