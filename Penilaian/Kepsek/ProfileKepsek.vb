...
Public Class ProfileKepsek
	Private Sub ProfileKepsek_Load(sender As Object, e As EventArgs) Handles MyBase.Load
	...
	Private Sub ProfileKepsek_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
