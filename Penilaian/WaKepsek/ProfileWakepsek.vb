...
Public Class ProfileWakepsek
	Private Sub ProfileWakepsek_Load(sender As Object, e As EventArgs) Handles MyBase.Load
		TextBox3.PasswordChar = "*"
	End Sub

	Private Sub ProfileWakepsek_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
