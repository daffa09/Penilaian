...
Public Class DataKepsek
	...
	Private Sub DataMurid_Load(sender As Object, e As EventArgs) Handles MyBase.Load
	...
	Private Sub DataMurid_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
