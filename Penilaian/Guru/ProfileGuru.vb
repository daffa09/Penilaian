...
Public Class ProfileGuru
	Private Sub ProfileGuru_Load(sender As Object, e As EventArgs) Handles MyBase.Load
	...
	Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
		...
		Else
			...
			If MsgBox("Apakah anda yakin ingin merubah data ini?", MsgBoxStyle.OkCancel, "Informasi") = MsgBoxResult.Ok Then
				...
				Call koneksi()
				cmd = New MySqlCommand("UPDATE guru SET username='" & TextBox2.Text & "', password='" & TextBox3.Text & "', nama='" & TextBox1.Text & "', alamat='" & TextBox4.Text & "', no_telp='" & TextBox5.Text & "' WHERE idguru='" & lblTangkapId.Text & "'", conn)
				cmd.ExecuteNonQuery()
	...
	Private Sub ProfileGuru_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
